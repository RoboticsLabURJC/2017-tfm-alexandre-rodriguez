...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{center}
        \\ \ \\
        \item \textbf{All points interpolation}: in this case the mean precision is done interpolating through all recall points (Equation \ref{all_1}). The precision at each level \textit{r} is obtained now taking the maximum precision which has a recall value greater or equal than \textit{r + 1} (Equation \ref{all_2}). This method of interpolation is used in Pascal VOC metrics from the year 2010 onwards.
