...
In this chapter, we will cover the \textit{state-of-the-art} and the \textit{previous-art} related to the topic of the thesis. First, the object tracking will be introduced including the algorithms, datasets and metrics used for a good development of a multiobject tracking system. Second, it will be discussed the object detection following the same previous scheme. Other necessary tools and interesting subjects from the literature will be also briefly commented.\\
...
\subsection{Multiple object tracking datasets}
\begin{itemize}
...
\section{Metrics for multiobject tracking evaluation}
Apart from the datasets and algorithms used to solve a given task or problem it is necessary to use a measure or measurements that can provide an evaluation of the performance of the obtained solution. In this section, the most important metrics used for evaluating \textit{multiple} object tracking are commented.\\
...
\section{Object classification and detection using neural networks}
...
\end{table}
 ...
 \end{itemize}
\section{Instance segmentation using neural networks}
...
\section{Metrics for object detection evaluation}
